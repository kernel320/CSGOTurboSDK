	...
	HRESULT __stdcall Hooked_EndScene(IDirect3DDevice9* pDevice) {
		if (!g_IsInitialized) {
			...
			if (OptionsManager.bShowMenu) {
				...
				ImGui::Begin(XorStr("Turbo's SDK / Small Base - By TurboVirgin"), &OptionsManager.bShowMenu, ImVec2(750, 500), OptionsManager.s_MenuTransparency, ImGuiWindowFlags_NoCollapse);
				{
